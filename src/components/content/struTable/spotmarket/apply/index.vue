    ...
    <div id="all">
							...
							<el-form :model="searchList">
								<div class="flx">
									<el-form-item label="业务名称" :label-width="formLabelWidth">
										<el-input placeholder="业务名称"  size="mini"  prefix-icon="el-icon-search" v-model="searchList.bus_name"></el-input>
									</el-form-item>
									<el-form-item label="流程状态" :label-width="formLabelWidth">
										<el-select v-model="searchList.process_state" placeholder="流程状态" clearable class="timeInput inputSize" size="mini">
											<el-option
									...
									<el-form-item label="审批状态" :label-width="formLabelWidth">
										<el-select v-model="searchList.app_state" placeholder="通道" clearable class="timeInput inputSize" size="mini">
											<el-option
        ...
        <div class="tableBox">
            <el-table ref="multipleTable" border :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="businessId" label="申请单编号" width="auto" align="center">
                </el-table-column>
                <el-table-column prop="formDataId" label="业务编号" width="auto" align="center">
                </el-table-column>
                <el-table-column prop="businessName" label="业务名称" width="auto" align="center">
                </el-table-column>
                <el-table-column prop="procinstId" label="流程实例编号" width="auto" align="center">
                </el-table-column>
                <el-table-column prop="flowState" label="流程状态" width="auto" align="center">
                </el-table-column>
				<el-table-column prop="approvalState" label="审批状态" width="auto" align="center">
				</el-table-column>
                <el-table-column prop="sponsorDate" label="申请时间" width="auto" align="center">
                </el-table-column>
              </el-table>
			<div class="block">
		...
		<!--<el-dialog title="查看详细" :visible.sync="dialogcheckFormVisible" class="elDialog">
			<el-form :data="editData">
				<div class="flx">
					<el-form-item label="申请单编号" :label-width="formLabelWidth">
					...
					<el-input v-model="editData.businessId" auto-complete="off" size="mini" disabled></el-input>
				</el-form-item>
				</div>
				<div class="flx">
					<el-form-item label="业务名称" :label-width="formLabelWidth">
					<el-input v-model="editData.businessName" auto-complete="off" size="mini"  disabled></el-input>
				</el-form-item>
					<el-form-item label="流程实例编号" :label-width="formLabelWidth">
						<el-input v-model="editData.procinstId" auto-complete="off" size="mini" disabled></el-input>
					</el-form-item></div>
					<div class="flx">
					<el-form-item label="流程状态" :label-width="formLabelWidth">
					<el-select v-model="editData.flowState" placeholder="请选择"  size="mini" disabled>
						<el-option
							v-for="item in transChannelOptions"
							:key="item.transChannelId"
							:label="item.transChannelName"
		...
		getPageData() {
			...
			var queryParam = {
				...
				data: {
					...
					limit: this.pageSize,
					filter_parameters: {
						/*businessName:this.searchList.bus_name,
						 flowState:this.searchList.process_state,
						 approvalState:this.searchList.app_state,
			 ...
			 this.$http.post(`${process.env.NODE_ENV}/spotmarket/flow/jsonlist `,queryParam)
			 	.then((response) => {
...
.el-date-editor.el-input, .el-date-editor.el-input__picker {
