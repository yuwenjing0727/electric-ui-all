	...
	export default {
		...
		methods: {
			...
			exportEXC() {
				...
				window.open(`${process.env.NODE_ENV}/spotmarket/dams/export?requestJson=`+JSON.stringify(queryParam));
			...
			getPageData() {
			    ...
			    * */
				var queryParam = {
				 ...
				 this.$http.post(`${process.env.NODE_ENV}/spotmarket/dams/list`,queryParam)
				 	.then((response) => {
