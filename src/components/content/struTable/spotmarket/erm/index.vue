		...
		<div class="tableBox">
			<div class="el-table">
				<el-table :data="tableData" style="width: 100%" border tooltip-effect="dark">
					...
					<el-table-column header-align="center" prop="stallDate" label="应收日期">
					</el-table-column>
	...
	export default {
		...
		methods:{
			...
			getPageData() {
				...
				this.$http.post(`${process.env.NODE_ENV}/spotmarket/epm/list`,queryParam)
					.then((response) => {
			...
			exportData(){
				...
				window.open(`${process.env.NODE_ENV}/spotmarket/epm/export?requestJson=`+JSON.stringify(queryParam));
			}
