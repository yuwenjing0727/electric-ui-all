						...
						<div class="transition-box">
							<el-form :model="searchList">
								<div class="flx">
									...
									<!--<el-form-item label="合约类型" label-width="70px">
										<el-select v-model="searchList.voidanceType" placeholder="合约类型">
								...
								<div class="flx">
									<el-form-item label="输电方" label-width="70px":label-width="formLabelWidth">
		...
		<div class="tableBox">
			<div class="el-table">
				<el-table :data="tableData" style="width: 100%" border tooltip-effect="dark">
					...
					<el-table-column header-align="center" prop="areaType" label="出清合约区域类型">
					</el-table-column>
					<el-table-column header-align="center" prop="voidanceType" label="出清合约类型">
					</el-table-column>
					<el-table-column header-align="center" prop="voidanceDate" label="出清时间">
					</el-table-column>
					<el-table-column header-align="center" prop="voidanceQuantity" label="出清电量">
					</el-table-column>
					<el-table-column header-align="center" prop="voidanceBeginDate" label="时间（自）">
					</el-table-column>
					<el-table-column header-align="center" prop="voidanceEndDate" label="时间（至）">
					</el-table-column>
					...
					<el-table-column header-align="center" prop="sendElectricPrice" label="送端出清电价">
					</el-table-column>
					<el-table-column header-align="center" prop="sendElectricQuantity" label="送端出清电量">
					</el-table-column>
					<el-table-column header-align="center" prop="sendPower" label="送端电力">
					</el-table-column>
					<el-table-column header-align="center" prop="receiveElectricPrice" label="受端电价">
					</el-table-column>
					<el-table-column header-align="center" prop="receivePower" label="受端电力">
					</el-table-column>
					<el-table-column header-align="center" prop="receiveElectricQuantity" label="受端电量">
					</el-table-column>
					<el-table-column header-align="center" prop="receiveElectricFee" label="受端电费">
					</el-table-column>
	...
	export default {
		...
		methods: {
			...
			getPageData() {
				...
				this.$http.post(`${process.env.NODE_ENV}/spotmarket/ipcc/list`,queryParam)
					.then((response) => {
