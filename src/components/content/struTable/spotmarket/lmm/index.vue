		...
		<div class="tableBox">
			<div class="el-table">
				<el-table :data="tableData" style="width: 100%" border tooltip-effect="dark">
					...
					<el-table-column header-align="center" prop="receivableMoney" label="应收金额">
					</el-table-column>
					<el-table-column header-align="center" prop="realyMoney" label="实收金额">
					</el-table-column>
					<el-table-column header-align="center" prop="receivablesDate" label="收款时间">
					</el-table-column>
					...
					<el-table-column header-align="center" prop="stallDate" label="应付时间">
				</el-table-column>
					<el-table-column header-align="center" prop="payDate" label="实付时间">
				</el-table-column>
	...
	export default {
		...
		methods: {
			...
			getPageData() {
				...
				this.$http.post(`${process.env.NODE_ENV}/spotmarket/lmm/list`,queryParam)
					.then((response) => {
			...
			exportData(){
				...
				window.open(`${process.env.NODE_ENV}/spotmarket/lmm/export?requestJson=`+JSON.stringify(queryParam));
			}
