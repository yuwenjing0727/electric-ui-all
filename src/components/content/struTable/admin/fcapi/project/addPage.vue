<template>
	<div  class="wrap">
		<div class="title">
			<span style="font-weight: 600;font-size: 18px">新增接口</span>
		</div>
		<div class="content">
			<div class="con_list">
				<div class="l_title">
					...
					<div class="l_btn">
						...
						<el-button type="primary" size="mini" @click="saveDocument">保存接口</el-button>
					</div>
				</div>
				<div class="formList">
	...
	export default {
		...
		methods: {
			...
			saveDocument(){
				...
				self.$http.post(`${process.env.NODE_ENV}/admin/fc/project/document/save`,queryParam)
					.then((response) => {
						if(response.data.code == 0){
							self.success("添加接口成功！");
							self.goBack();
